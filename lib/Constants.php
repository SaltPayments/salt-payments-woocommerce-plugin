...
const SKIP_AVS_VALIDATE = 0;
const AVS_VALIDATE = 1;
const SKIP_CVV_VALIDATE = 0;
const VALIDATE_CVV = 1;

const VALID_CHARGE_AMOUNT = '100';
const INVALID_CHARGE_AMOUNT = '-1';
...
define('VALID_CVV','111');
define('INVALID_CVV','0ABC');
